...
#define BUFFER_SIZE 500 //ring buffer size
...
struct ringBufS debugRingBuff;
struct ringBufS OutGoing_DataTransBuff;  //this holds the output data for the fastTrans
struct ringBufS lantxRingBuff;
...
bool receiveData();
void ToSend(const unsigned char where, const unsigned int what, struct ringBufS *_ringBuff);
